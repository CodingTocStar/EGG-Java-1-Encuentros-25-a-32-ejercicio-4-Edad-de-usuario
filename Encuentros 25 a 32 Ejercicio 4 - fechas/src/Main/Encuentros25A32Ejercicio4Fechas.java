 ...
 * @author MiriamNahuel
 */
public class Encuentros25A32Ejercicio4Fechas {
    ...
    public static void main(String[] args) {
       ...
       Date fechaNacimiento = nuevaFecha.fechaNacimiento();
       
       Date fechaActual = nuevaFecha.fechaActual();
       
        System.out.println("Su edad es: " + nuevaFecha.edadUsuario(fechaNacimiento, fechaActual));
    }
